...
namespace CapaDato
{
   public class CrearTicket
    {
        ...
        public void EncabezadoVenta()
        {
            ...
            linea.AppendLine("PRODUCTO            |CANT|PRECIO|SUBTOTAL");
        }
        public void EncabezadoIva()
        {
            //Escribimos los espacios para mostrar el articulo. En total tienen que ser 40 caracteres
            linea.AppendLine("IMPUESTO            |CANT|SUBTOTAL");
        }
   ...
   public class RawPrinterHelper
   {
       ...
       public static bool SendBytesToPrinter(string szPrinterName, IntPtr pBytes, Int32 dwCount)
       {
           ...
           di.pDocName = "Ticket";//Este es el nombre con el que guarda el archivo en caso de no imprimir a la impresora fisica.
