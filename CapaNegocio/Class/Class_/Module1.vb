Module Module1
    ...
    Private Sub imprimir_ticket()
        ''Dim ticket As New LibPrintTicket.Ticket
        ...
        'Para enviar la orden de corte del papel manda la cadena "\x1B" + "m"
        ...
        '{
        '        ticket.AddItem(fila.Cells["cant"].Value.ToString(), fila.Cells["descripcion"].Value.ToString(), fila.Cells["importe"].Value.ToString());
        '}
